...
5. **Strategi Fu–On**: rancangan 21 Fu, 30 Ch, 30 Am, 30 Pi, 29 On untuk **tepat 140 siswa**. Siswa dengan kurang dari 3 nilai per mapel utama masuk **On sementara** disertai jumlah nilai dan alasan; jika siswa tersebut peserta TKA, tampil peringatan **pengecualian sementara** untuk ditinjau sekolah, bukan vonis kemampuan. Peserta TKA dengan data cukup masuk Fu, Ch, atau Am. Jika data kurang mencakup lebih dari 29 siswa, kapasitas On tidak memadai sehingga aplikasi meminta keputusan manusia; tidak menebak penempatan. Kolom peringkat ada di samping rekomendasi. Kartu ringkasan dan grafik skor berwarna mengikuti cakupan sidebar; grafik hanya merata-ratakan siswa yang benar-benar punya skor pada TO itu. Usulan ini bukan keputusan akhir sekolah.
